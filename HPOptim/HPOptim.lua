...
function HPOptim.findHP(time)
    ...
    os.execute("mongod --fork --logpath $HOME/logs/mongod.log --dbpath $HOME/data/db")
    os.execute("timeout "..time.." python $HOME/Spearmint/spearmint/main.py "..HPOptim.dir_path)
